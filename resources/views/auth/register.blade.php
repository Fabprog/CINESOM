    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        :root {
            ...
            --text: #f0f0f0; --muted: #555; --accent: #1DB954; --error: #e05252;
        }
    ...
    <div class="card">
        ...
        <form method="POST" action="/register" autocomplete="off">
            ...
            <div class="field">
                ...
                <input type="email" id="email" name="email" value="{{ old('email') }}" required autocomplete="email" maxlength="254">
